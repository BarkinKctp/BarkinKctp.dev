...
import type { Place, Book, Music } from "@/lib/about";
...
export default function AboutMeClient({ places, books, music }: Props) {
  return (
    <motion.main
    ...
    >
      ...
      >
        ...
        >
          ...
          . <br />
          I&apos;m currently learning <span className="font-bold">
            French
          </span>{" "}
          and practicing the <span className="font-bold">piano</span>.
        </p>
      </motion.div>
